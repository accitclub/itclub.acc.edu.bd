...
export default function Hero() {
    return (
        <Main id={HERO_ID} className={"h-min-screen"}>
            <Section >
                <Content className={`bg-gradient-to-b from-cyan-500 to-blue-500`}>
                    <Relative className="overflow-hidden lg:container lg:mx-auto grid lg:grid-cols-2">
                        ...
                        <Content className="overflow-visible order-1 mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-32">
            ...
            <Wave className={"-mt-10 bg-bgLight text-blue-500"}/>
        </Main>
    )
}