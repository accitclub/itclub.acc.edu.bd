...
export default function Carousel({children,
    ...
    const getNextSlideNumber = () => (
        currentSlideNumber === getSlideArray().length - 1 ? 0 : currentSlideNumber + 1
    )

    const getPrevSlideNumber = () => (
        currentSlideNumber === 0 ? getSlideArray().length - 1 : currentSlideNumber - 1
    )
    ...
    return(
        <div ref={carousel} className={classNames("carousel", className)}>
